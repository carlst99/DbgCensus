...
/// <param name="AttackerTeamID">The currently assigned faction of the attacking character.</param>
...
/// <param name="TeamID">The currently assigned faction of the killed character.</param>
