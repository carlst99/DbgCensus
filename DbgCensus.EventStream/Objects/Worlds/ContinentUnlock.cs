...
/// <param name="MetagameEventID">The metagame event that triggered this unlock.</param>
/// <param name="NCPopulation">The NC population percentage at the time of unlocking.</param>
...
/// <param name="TRPopulation">The TR population percentage at the time of unlocking.</param>
/// <param name="TriggeringFaction">The faction that unlocked the continent.</param>
/// <param name="VSPopulation">The VS population percentage at the time of unlocking.</param>
/// <param name="WorldID">The world on which the event occured.</param>
/// <param name="ZoneID">The zone on which the event occured.</param>
public record ContinentUnlock
(
    string EventName,
